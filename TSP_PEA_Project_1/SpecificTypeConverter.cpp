...
#include "SpecificTypeConverter.h"
...
//---------------------------------------------------------------------
void SpecificTypeConverter::error_exit(const string& msg)
{
    cout << msg << endl;
    system("PAUSE");
    exit(1);
...
//---------------------------------------------------------------------
int SpecificTypeConverter::header_get_size(ifstream& file)
{
    int     header_lines = 0;
    int     size = 0;
    string  line;
...
//---------------------------------------------------------------------
int SpecificTypeConverter::value_digits(int val)
{
    int width = 0;
...
//---------------------------------------------------------------------
int SpecificTypeConverter::convert()
{
    ifstream    file_in;
    ofstream    file_out;
    int         size;
